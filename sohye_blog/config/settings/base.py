...
ROOT_DIR = environ.Path(__file__) - 3  # (sohye_blog/config/settings/base.py - 3 = sohye_blog/)
APPS_DIR = ROOT_DIR.path('sohye_blog')
...
MIGRATION_MODULES = {
    'sites': 'sohye_blog.contrib.sites.migrations'
}
